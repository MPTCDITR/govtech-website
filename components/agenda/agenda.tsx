          ...
          <div className="mt-8 flex justify-items-center">
            <table className="border-collapse border border-slate-500">
              ...
              <tbody>
                  ...
                  <tr>
                    <td rowSpan="5" className="border border-slate-700 text-center">09:30-11:00</td>
                  ...
                  <tr>
                    <td rowSpan="4" className="border-slate-700 text-center" >14:30-15:30</td>
                    <td className="border border-slate-700 p-2">
                      <h1 className="font-bold">Main Stage </h1>
                      Presentation WoG
                    </td>
                  ...
                  <tr>
                    <td rowSpan="4" className="border border-slate-700 text-center">15:30-17:00</td>
                    <td className="border border-slate-700 p-2">
                      <h1 className="font-bold">Main Stage </h1>
                      Presentation WoG
                    </td>
